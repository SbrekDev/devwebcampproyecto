        ...
        <?php foreach($ponentes as $ponente) { ?>
            <div class="speaker">
                <picture>
                    ...
                    <img loading="lazy" width="200" height="300" class="speaker__imagen" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="imagen ponente">
                </picture>

                <div class="spealer__informacion">
